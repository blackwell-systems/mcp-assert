...
| **Vitest plugin** | 0.7.0 | `npm install -D @blackwell-systems/vitest-mcp-assert`. Auto-discover YAML files or per-test control. Same bridge architecture as pytest plugin. |

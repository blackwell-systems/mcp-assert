...
|------|----------|-------------|
| **MCP server leaderboard** | High | Static page on the docs site ranking servers by coverage score. Data already exists for 38 servers. Free SEO, gives server authors a reason to improve and adopt mcp-assert. |
...
| **Grafana, Playwright, Google, OpenAI, arxiv, git-mcp suites** | 0.5.0 | 38 servers scanned, 462 assertions, 44 suites. All 4 major tech companies covered. |

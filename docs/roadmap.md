...
|------|----------|-------------|
| **MCP server leaderboard** | High | Static page on the docs site ranking servers by coverage score. Data already exists for 30 servers. Free SEO, gives server authors a reason to improve and adopt mcp-assert. |
...
| **Grafana, Playwright, Google, OpenAI, arxiv, git-mcp suites** | 0.5.0 | 30 servers scanned, 386 assertions, 39 suites. All 4 major tech companies covered. |
